  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Container(
          ...
          child: CustomPaint(
            painter: DigitalClockPainter(textStyle: widget.textStyle, format: widget.format, showSeconds: widget.showSeconds, datetime: datetime, digitalClockTextColor: widget.digitalClockTextColor, textScaleFactor: widget.textScaleFactor),
          )),
    );
  }
